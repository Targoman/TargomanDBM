...
#ifndef TARGOMAN_DBMANAGER_PRIVATE_DRIVERS_CLSDACDRIVER_IBase_H
#define TARGOMAN_DBMANAGER_PRIVATE_DRIVERS_CLSDACDRIVER_IBase_H
...
public:
    ...
    {Q_UNUSED(_spName); Q_UNUSED(_spParams); Q_UNUSED(_spArgs) Q_UNUSED(_boundingVars); throw Common::exTargomanNotImplemented("IBase Driver has not yet been developped");}

    QString boundSPQuery(const QString& _spName, const QStringList& _boundingVars)
    {Q_UNUSED(_spName); Q_UNUSED(_boundingVars); throw Common::exTargomanNotImplemented("IBase Driver has not yet been developped");}


    enuSQLAbstractDataType::Type   abstractDataType(const QString& _typeStr)
    {Q_UNUSED(_typeStr); throw Common::exTargomanNotImplemented("IBase Driver has not yet been developped");}

    SPParams_t getSPParams(QSqlQuery& _connectedQuery,
                           const QString _schema,
                           const QString& _spName)
    {Q_UNUSED(_connectedQuery); Q_UNUSED(_schema); Q_UNUSED(_spName); throw Common::exTargomanNotImplemented("IBase Driver has not yet been developped");}


    QStringList whichOnesAreUpdated(const QSqlDatabase & _dbc,
                                    const QStringList& _tableNames,
                                    QDateTime& _pLastCheckTime)
    {Q_UNUSED(_dbc); Q_UNUSED(_tableNames); Q_UNUSED(_pLastCheckTime); throw Common::exTargomanNotImplemented("IBase Driver has not yet been developped");}
...
#endif // TARGOMAN_DBMANAGER_PRIVATE_DRIVERS_CLSDACDRIVER_IBase_H
